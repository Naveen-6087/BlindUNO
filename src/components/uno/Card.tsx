    ...
    return (
      <button
        ...
        className={`
          ...
          ${!disabled ? "hover:shadow-lg cursor-pointer hover:-translate-y-1" : "cursor-not-allowed grayscale-[30%]"}
  ...
  return (
    <button
      ...
      className={`
        ...
        ${colors.shadow}
        transition-transform duration-150 ease-out
        ${!disabled ? "hover:shadow-lg cursor-pointer hover:-translate-y-1" : "cursor-not-allowed"}
